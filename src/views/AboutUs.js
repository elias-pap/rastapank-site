                        ...
                        <Container>
                            <Row>
                                <Col className="ml-auto mr-auto" md="8">
                                    ...
                                    Ο Ρα.Στα.Πάν.Κ 96,7 (ΡΑδιοφωνικός ΣΤΑθμός του ΠΑΝεπιστημίου Κρήτης) είναι αυτοδιαχειριζόμενη ομάδα που μεταξύ άλλων λειτουργεί ανεξάρτητο φοιτητικό ραδιοφωνικό σταθμό στο Ηράκλειο. Στεγάζεται σε ένα κτίριο στους πρόποδες του κάμπου(ς) του Πανεπιστημίου στις Βούτες, και είναι ανοιχτός σε όποιον αποδέχεται την διαφορετικότητα και την ελεύθερη έκφρασή της, εντός και εκτός Πανεπιστημίου. 
                                    <br/><br/>
                                    Η λειτουργία του βασίζεται στην αφιλοκερδή πρωτοβουλία, η οργάνωση και λήψη αποφάσεων γίνεται σε εβδομαδιαία γενική συνέλευση, ενώ η οικονομική ανατροφοδότηση του εγχειρήματος επιτυγχάνεται από τις δωρεές των μελών του και από συνεισφορές του κόσμου στις διάφορες εκδηλώσεις που οργανώνει. Επίσης από το 2017 το Πανεπιστήμιο χορηγεί την ενοικίαση και την ηλεκτροδότηση οικίσκου στο πάρκο κεραιών της Ρογδιάς, όπου έχει εγκατασταθεί εξοπλισμός για εκπομπή σήματος FM προς τους ραδιοφωνικούς δέκτες του Ηρακλείου.
                                    <br/><br/>
                                    Η ομάδα επιδιώκει το πειραματισμό, την απο-εμπορευματοποίηση, και ενεργά χρησιμοποιεί, σχεδιάζει και συνεισφέρει ελεύθερο/ανοιχτό λογισμικό και δεδομένα. Με την παρέμβασή της στα κοινά προσδοκά στην ανάδειξη πολιτιστικής και αισθητικής ποικιλομορφίας, στην αναζήτηση επιστημονικής ή εμπειρικής γνώσης, με απώτερο στόχο την ατομική και συλλογική υπέρβαση.
                                    </h5>
